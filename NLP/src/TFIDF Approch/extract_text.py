...
test = pd.read_csv(
    r"/Users/elros/General/Projects/SkillBrew/placement_cell/NLP/dataset/test.csv"
)
train = pd.read_csv(
    r"/Users/elros/General/Projects/SkillBrew/placement_cell/NLP/dataset/train.csv"
)

# Paths
train_path = (
    r"/Users/elros/General/Projects/SkillBrew/placement_cell/NLP/dataset/trainResumes"
)
test_path = (
    r"/Users/elros/General/Projects/SkillBrew/placement_cell/NLP/dataset/testResumes"
)
